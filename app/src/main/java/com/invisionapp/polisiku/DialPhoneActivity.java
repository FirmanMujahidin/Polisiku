...
public class DialPhoneActivity extends AppCompatActivity {
    ...
    private static final String TAG = "DialPhoneActivity";
    public String url_polisiku="https://invision.io/polisiku/phone.html";
    String url_test = "https://wss.icephone.id:8888/shared/examples/demo/sip/phone-ui/ln-99790f15aaf40b992eac01819b189f90";
        ...
        if (webView != null){
            ...
            webView.setWebChromeClient(new WebChromeClient() {
                ...
                public void onPermissionRequest(final PermissionRequest request) {
                    ...
                    DialPhoneActivity.this.runOnUiThread(new Runnable() {
